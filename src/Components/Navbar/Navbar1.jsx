...
const Navbar1 = () => {
    ...
    return (
        <div>
            <nav className={` flex justify-between ${dropDownState ? ' h-screen w-screen  bg-[#0005]' : 'flex items-center justify-between bg-[#FFFFFF]  px-4 h-[4rem]'} `}>
                ...
                <div className='hidden items-center justify-between gap-7 lg:gap-10 md:flex'>
                    <ul className="hidden items-center justify-between gap-7 lg:gap-10 md:flex">
                        ...
                        <li className="group flex text-sm lg:text-base cursor-pointer flex-col text-[#333333] hover:text-[#48cab2] font-bold">
                            BUY THEME!  <span className="mt-[2px] h-[3px]  w-[0px] rounded-full bg-[#48cab2] transition-all duration-300 group-hover:w-full"></span>
                        </li>
                    </ul>
                ...
                <div className="relative flex transition-transform md:hidden">
                    ...
                    {dropDownState && (
                        <ul className=" z-10  gap-2  bg-[#FFFFFF]  absolute right-0 top-11 flex w-[200px] flex-col  rounded-lg   text-base ">
                            <li className="cursor-pointer  px-6 py-2 text-[#333333] rounded-t-lg hover:bg-[#48cab2] ">
                                HOME
                            </li>
